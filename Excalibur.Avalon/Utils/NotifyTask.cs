...
namespace Excalibur.Avalon.Utils
{
    ...
    public sealed class NotifyTask : INotifyPropertyChanged
    {
        ...
        public static NotifyTask<TResult> Create<TResult>(Task<TResult> task, TResult defaultResult = default) => new NotifyTask<TResult>(task, defaultResult);
        ...
        /// <param name="asyncAction">The asynchronous code to execute.</param>
        /// <param name="defaultResult">The default "result" value for the task while it is not yet complete.</param>
        public static NotifyTask<TResult> Create<TResult>(Func<Task<TResult>> asyncAction, TResult defaultResult = default) => Create(asyncAction(), defaultResult);
    }
