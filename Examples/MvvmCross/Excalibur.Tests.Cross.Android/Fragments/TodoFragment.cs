...
namespace Excalibur.Tests.Cross.Droid.Fragments
{
    ...
    public class TodoFragment : BaseFragment<TodoViewModel>
    {
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var recyclerView = view.FindViewById<MvxRecyclerView>(Resource.Id.recycler_todo);
            ...
            var swipeToRefresh = view.FindViewById<MvxSwipeRefreshLayout>(Resource.Id.recycler_todo_refresh);
