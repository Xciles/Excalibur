...
namespace Excalibur.Tests.Encrypted.Cross.Core.Presentation
{
    public class Todo : BaseListPresentation<int, Domain.Todo, Observable.Todo, Observable.Todo>, ITodo
    {
        ...
        public Todo
            (
                IObjectMapper<Domain.Todo, Observable.Todo> domainSelectedMapper,
                IObjectMapper<Domain.Todo, Observable.Todo> domainObservableMapper,
                IObjectMapper<Observable.Todo, Observable.Todo> observableSelectedMapper,
                IListBusiness<int, Domain.Todo> listBusiness,
