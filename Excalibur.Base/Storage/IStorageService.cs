...
namespace Excalibur.Base.Storage
{
    ...
    public interface IStorageService
    {
        ...
        /// <returns>The native path of the stored file</returns>
        Task<string> Store(string folder, string fullName, string contentAsString);
        ...
        /// <returns>The native path of the stored file</returns>
        Task<string> Store(string folder, string fullName, byte[] contentAsBytes);
        ...
        Task<string> ReadAsText(string folder, string fullName);
        ...
        Task<byte[]> ReadAsBinary(string folder, string fullName);
